...
export default {
  ...
  computed: {
    ...mapState({
      ...
      orderInfo: (state) => state.trade.order,
    }),
    //将来提交订单最终信息
    userDefaultAddress() {
      //find方法用来查找数组中符合条件的数据
      //加空对象的原因是原来就没有符合的数据，因此需加个空对象，否则会报错
  ...
  methods: {
   ...
   async submitOrder() {
      ...
      let data = {
        ...
        consigneeTel: this.userDefaultAddress.phoneNum,//手机号码
        paymentWay: "ONLINE",//支付方式
        deliveryAddress: this.userDefaultAddress.fullAdress,//地址
